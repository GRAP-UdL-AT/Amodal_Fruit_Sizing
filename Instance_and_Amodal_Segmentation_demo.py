...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(
        ...
        test_name='WUR_prova',
        dataset_path="/mnt/gpid07/users/jordi.gene/amodal_segmentation/data/apple_WUR/190823-Tree27_W_fl16/images/",
        split='test',
    ...
    for r, d, f in os.walk(dataset_path):
        for file in f:
            if file.endswith(".png") or file.endswith(".jpg") or file.endswith(".JPG"):
                ...
                visualizer_amodal = Visualizer(img[:, :, ::-1], metadata=dataset_metadata, scale=0.8)
                vis_amodal = visualizer_amodal.draw_instance_predictions(outputs["instances"].to("cpu"))
                visualizer_instance = Visualizer(img[:, :, ::-1], metadata=dataset_metadata, scale=0.8)
