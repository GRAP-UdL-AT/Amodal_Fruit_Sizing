...
#PBL
__all__ = ["default_argument_parser", "default_setup", "DefaultPredictor", "DefaultTrainer", "ModalMaskHeadTrainer"]
...
# PBL: made a new trainer (inspired on DefaultTrainer) to only train the visible mask head
class ModalMaskHeadTrainer(SimpleTrainer):
    """
    A trainer with default training logic. Compared to `SimpleTrainer`, it
    contains the following logic in addition:
    ...
    def __init__(self, cfg):
        ...
        # PBL: only train the visible mask head
        ...
        # PBL: print the layers that will be trained
