...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotation_dir', type=str, default="/mnt/gpid07/users/jordi.gene/amodal_segmentation/data/Broccoli_WUR/annotations/combined_annotations/", help='file directory with the images and the annotations')
    parser.add_argument('--write_dir', type=str, default="/mnt/gpid07/users/jordi.gene/amodal_segmentation/data/Broccoli_WUR/annotations/orcnn_annotations/", help='file directory to write the images and the annotations')
